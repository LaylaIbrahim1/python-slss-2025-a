...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        ...
        # load the image
        self.image = pygame.image.load("assets/Adobe Express - file.png")
...
def game():
    ...
    background = pygame.image.load("assets/Untitled design.jpg")
...
dq
        ...
        enemies_collided = pygame.sprite.spritecollide(player, enemy_sprites_group, True)
